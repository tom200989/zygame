...
public class RootComponent {
    ...
    public static int SETTING_DEFAULT_PLAY_MIN = 40;// 默认玩耍时长:min
    public static int SETTING_DEFAULT_REST_MIN = 60;// 默认休息时长:min
    public static long SETTING_DEFAULT_PLAY_DURATION = SETTING_DEFAULT_PLAY_MIN * 60 * 1000;// 默认玩耍时长:ms
    public static long SETTING_DEFAULT_REST_DURATION = SETTING_DEFAULT_REST_MIN * 60 * 1000;// 默认休息时长:ms
}
